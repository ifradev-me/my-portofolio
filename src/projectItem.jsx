...
const ProjectItem = ({ project }) => {
    ...
    const mobileBg = buildImageUrl(project.image, 800)
    const desktopSrc = buildImageUrl(project.image, 800)

    return (
        <>
            {/* Mobile Version - Full Screen Card */}
            <div className="lg:hidden font-body flex flex-col items-center justify-end bg-gradient-to-t from-background-950 via-background-800/60 to-transparent p-6 pb-24 h-screen text-text-50 border-x-2 border-border-gold relative overflow-hidden">
                ...
                <div className="relative z-10 text-center space-y-4 max-w-sm bottom-[20%]">
                    ...
                    {(project.demoUrl || project.githubUrl) ? (
                        ...
                        <p className="text-xs text-text-300/70 italic mt-4">Link belum tersedia</p>
                    )}
                </div>
            </div>
                ...
                <div className="p-6 relative z-10 flex flex-col">
                    <div className="flex-1">
                        ...
                        {(project.demoUrl || project.githubUrl) ? (
                            ...
                            <p className="text-xs text-text-400 italic mb-4">Link belum tersedia</p>
                        )}
                    </div>
