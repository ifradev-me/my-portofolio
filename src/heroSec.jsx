...
const HeroSection = () => {
    return (
        <div className="relative h-screen flex flex-col p-5 overflow-hidden text-text-light">
            ...
            <h1 className="flex-shrink-0 text-bold text-3xl sm:text-3xl text-left font-header mb-3 sm:mb-4 z-[1]">
            ...
            <p className="flex-shrink-0 text-sm sm:text-md text-left font-body mt-4 sm:mt-6 z-[1]">
